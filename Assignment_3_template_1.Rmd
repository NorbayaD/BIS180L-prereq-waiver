...
The above snippet adds all whole numbers between 2000 and 20000 together using the sum() function
...
```
the values are different. the ab1 output shows that the value of a (5) will be added to each of the numbers in b (2:20), which produces several different sum number values. 
...
this argument selects for values in the data m only from row 3 and across all columns. 
...
Enter the file name(s) here: 1) Assignment_3_template_1.html, Assignment_3_template_1.Rmd
